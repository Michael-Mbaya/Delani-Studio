...
$(document).ready(function() {
    $(".img-do2").click(function() {
      $(".describe2").slideToggle();
      $(".img-do2").slideToggle();
    });
    $(".describe2").click(function() {
        $(".img-do2").slideToggle();
        $(".describe2").slideToggle();
    }); 
});
...
$(document).ready(function(){
  $('#hover1').hover(function(){
    $('#hovershow1').fadeToggle(750);
    }, function(){
    $('#hovershow1').fadeToggle(500);
  });
});

$(document).ready(function(){
  $("#hover2").hover(function(){
    $("#hovershow2").fadeToggle(750);
    }, function(){
    $("#hovershow2").fadeToggle(500);
  });
});

$(document).ready(function(){
  $("#hover3").hover(function(){
    $("#hovershow3").fadeToggle(750);
    }, function(){
    $("#hovershow3").fadeToggle(500);
  });
});

$(document).ready(function(){
  $("#hover4").hover(function(){
    $("#hovershow4").fadeToggle(750);
    }, function(){
    $("#hovershow4").fadeToggle(500);
  });
});
